...
const FEEDS = [
  ...
  { id: 'atp_tennis', label: 'ATP Tour', sport: '網球', url: 'https://www.atptour.com/en/news/rss-feed' },
  { id: 'tennis_abstract', label: 'Tennis Abstract', sport: '網球', url: 'https://www.tennisabstract.com/blog/feed/' },
  { id: 'the_race_f1', label: 'The Race F1', sport: 'F1', url: 'https://www.the-race.com/formula-1/feed/' },
  { id: 'autosport_f1', label: 'Autosport F1', sport: 'F1', url: 'https://www.autosport.com/rss/f1/news/' },
];
...
const detectSport = (title = '', fallback = '綜合') => {
  ...
  if (/tennis|\batp\b|\bwta\b|grand slam|wimbledon|roland garros|us open|australian open/.test(t)) return '網球';
  if (/formula 1|formula one|\bf1\b|grand prix|qualifying/.test(t)) return 'F1';

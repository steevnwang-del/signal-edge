...
export const buildAnalysisFromOddsEvent = (event, {
  ...
  return {
    ...
    dataBlock,
    modelVersion: 'v6e-foreign-analyst-masters',
...
【國外分析大師雷達】
用 80-130 字整理 DATA_BLOCK_JSON.analystRadar 中應優先核對的國外分析大師/數據源；若 DATA_BLOCK_JSON.foreignAnalystPicks 有命中，整理其短摘錄/中文摘要與 SignalEdge 模型是否一致。不得寫成保證或照抄全文。
